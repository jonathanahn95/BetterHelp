...
Business.create!([
  ...
  phone_number: '(646) 833-7532', website: 'https://www.burgerandlobster.com/', city: "New York", state: "NY", zip_code: 10018, business_category_id: business_categories[0].id, latitude: 41.915495, longitude: -74.002210},
  ...
  phone_number: '(212) 302-0650', website: 'https://www.chipotle.com/', city: "New York", state: "NY", zip_code: 10018, business_category_id: business_categories[0].id, latitude: 40.915495, longitude: -74.002210},
  ...
  phone_number: '(917) 410-1761', website: 'https://www.carpetcleaningnycpro.com', city: "Queens", state: "NY", zip_code: 11374, business_category_id: business_categories[1].id ,latitude: 41.888888, longitude: -73.899999 },
  ...
  phone_number: '(201) 855-9052', website: 'https://www.maidstay.com', city: "Queens", state: "NY", zip_code: 11374, business_category_id: business_categories[1].id ,latitude: 41.888888, longitude: -73.777777 },
  ...
  phone_number: '(718) 855-9052', website: 'https://www.orbitsecuritysystems.com', city: "Queens", state: "NY", zip_code: 11374, business_category_id: business_categories[1].id ,latitude: 41.331122, longitude: -73.331122 },
  ...
  phone_number: '(718) 122-7323', website: 'https://www.rightlawncare.com', city: "Jamaica", state: "NY", zip_code: 11374, business_category_id: business_categories[1].id ,latitude: 40.631888, longitude: -73.899999 },
  ...
  phone_number: '(646) 869-2070', website: 'https://absolutecoffee.nyc', city: "Manhattan", state: "NY", zip_code: 10001, business_category_id: business_categories[2].id, latitude: 41.339181, longitude: -73.703888 },
  ...
  phone_number: '(929) 718-3213', website: 'https://coffeeprojectny.com', city: "New York", state: "NY", zip_code: 10004, business_category_id: business_categories[2].id ,latitude: 40.333111, longitude: -71.002218 },
  ...
  Review.create!([
    ...
    {user_id: users[0].id, business_id: businesses[5].id, rating: 4, body: "They did a amazing impeccable job on my carpet, it looks brand new again!! Professional and friendly, with affordable prices. It was top notch service all around." },
    {user_id: users[0].id, business_id: businesses[5].id, rating: 4, body: "Thank you so much Carpet Cleaning! I really could not be happier with the result! My living room carpet looks amazing! After years of wearing out outdoor shoes all over it, my carpet went from beige to grey dark spots all over. " },
    {user_id: users[0].id, business_id: businesses[6].id, rating: 1, body: "Don't be fooled by the the average star ratings like me, read reviews before you go! I was shock by how stingy the portion they gave, even the brown rice and beans! Not to mention the chicken! Unbelievable. By far the most stingy location I've ever been." },
    {user_id: users[0].id, business_id: businesses[6].id, rating: 1, body: "They broke the record. I had a chicken bowl, I felt I got a veggie bowl. I can count the pieces of chicken and to make it worse, they didn't even taste good. Dry and chewy. The people behind the bar were not friendly at all. They had no clue what customer service was. This was my first and last time here." },
    {user_id: users[0].id, business_id: businesses[6].id, rating: 3, body: "I have been waiting for years to eat here. Left vastly disappointed. The food was ok at best. The servers service was awful. I make question and they weren't responsive . For me this was subway with a texmex vari" },
    {user_id: users[0].id, business_id: businesses[6].id, rating: 1, body: "This is the worst chipotle I have ever been to and I am a certified chipotle addict! I work near by and have been here several times but I am completely done with this location for good! The portions they give you are disgustingly unacceptable!" },
    {user_id: users[0].id, business_id: businesses[6].id, rating: 4, body: "Ever since working nearby at a salad place, I go to this chipotle store location almost everyday. The environment is pleasant , the food tastes great and the employees are very helpful. In particular, the pretty girl with the curly hair always keeps a smile on my face " },
    {user_id: users[0].id, business_id: businesses[7].id, rating: 4, body: "Good place to work. Limited space (comfortably fits 10 people.) Outside bench available. Classy baristas. Unique decorations (ie. upside down chemistry lab beaker used as coffee drip.)"},
    {user_id: users[0].id, business_id: businesses[7].id, rating: 2, body: " My friend and I were really really disappointed with the coffee. The cold brew was watered down. I told them I love  strong black coffee and they recommended Costa Rica coffee. I was so excited and can't wait to try it." },
    {user_id: users[0].id, business_id: businesses[7].id, rating: 2, body: "The only good was the deconstructed latte, it was unique and cute for Instagram. I don't really like latte but it's pretty good. It comes with a shot of espresso and I enjoyed that. I should have just order the espresso." },
    ...
    {user_id: users[0].id, business_id: businesses[8].id, rating: 4, body: "Good vibes, nice people and an excellent staff that master code. Don't even over think it. Do it." },
    {user_id: users[0].id, business_id: businesses[8].id, rating: 4, body: "The young instructors were very energetic and encouraging and able to communicate their enthusiasm for coding to their students, some of whom came with some knowledge of the subject, and others with none at all. " },
    {user_id: users[0].id, business_id: businesses[8].id, rating: 3, body: "The pace was too slow. Felt as if I could have learned most of the cirriculum by myself at home. Still learned alot but expected much more. " },
