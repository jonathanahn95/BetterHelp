...
Business.create!([
  ...
  Review.create!([
    ...
    Funny.create!([
      { review_id: reviews[6].id, user_id: users[0].id}
      ])
    Cool.create!([
      { review_id: reviews[6].id, user_id: users[0].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[7].id, user_id: users[0].id}
      ])
    Cool.create!([
      { review_id: reviews[7].id, user_id: users[0].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[7].id, user_id: users[1].id}
      ])
    Cool.create!([
      { review_id: reviews[7].id, user_id: users[1].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[7].id, user_id: users[2].id}
      ])
    Cool.create!([
      { review_id: reviews[7].id, user_id: users[2].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[8].id, user_id: users[0].id}
      ])
    Cool.create!([
      { review_id: reviews[8].id, user_id: users[0].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[9].id, user_id: users[0].id}
      ])
    Cool.create!([
      { review_id: reviews[9].id, user_id: users[0].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[10].id, user_id: users[0].id}
      ])
    Cool.create!([
      { review_id: reviews[10].id, user_id: users[0].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[10].id, user_id: users[1].id}
      ])
    Cool.create!([
      { review_id: reviews[10].id, user_id: users[1].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[10].id, user_id: users[2].id}
      ])
    Cool.create!([
      { review_id: reviews[10].id, user_id: users[2].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[11].id, user_id: users[0].id}
      ])
    Cool.create!([
      { review_id: reviews[11].id, user_id: users[0].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[12].id, user_id: users[0].id}
      ])
    Cool.create!([
      { review_id: reviews[12].id, user_id: users[0].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[13].id, user_id: users[0].id}
      ])
    Cool.create!([
      { review_id: reviews[13].id, user_id: users[0].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[14].id, user_id: users[0].id}
      ])
    Cool.create!([
      { review_id: reviews[14].id, user_id: users[0].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[15].id, user_id: users[0].id}
      ])
    Cool.create!([
      { review_id: reviews[15].id, user_id: users[0].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[15].id, user_id: users[1].id}
      ])
    Cool.create!([
      { review_id: reviews[15].id, user_id: users[1].id}
      ])
    ...
    Funny.create!([
      { review_id: reviews[15].id, user_id: users[2].id}
      ])
    Cool.create!([
      { review_id: reviews[15].id, user_id: users[2].id}
      ])
