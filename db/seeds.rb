...
Business.create!([
  ...
  Review.create!([
    ...
    {user_id: users[0].id, business_id: businesses[2].id, rating: 5, body: "I hired Liaison Landscapes to help me with the buying and installation of plants and with irrigation. It was an all around great experience to work with Markus and his crew, and I would highly recommend them to others for their landscape needs. Some highlights: 1) To obtain a quote was easy and quick. Liaison came in competitively priced and was available to get started on the project right away. Both of these items are not all that trivial in this busy real estate development market in SF. 2)  Markus is flexible and easy to work with. I elected to make some significant deviations from the original plans at the beginning and during the course of the project, which made things more difficult to price out and execute on. Markus didn't sweat these changes and delivered based on our original time frame. And it was easy to settle things fairly price-wise at the end of the project (i.e. he didn't gouge me for such changes). 3) Markus was responsive and made sure that I was happy with the final product. He is almost always available via phone, and if not, he will return your phone calls within the same day. He will address any needs to fix any issue or address any changes in a timely manner. I couldn't be happier with the beautiful back yard that resulted from working with Liaison. I would recommend Liaison Landscapes without any hesitation." },
    ])
