...
Business.create!([
  ...
  phone_number: '(646) 833-7532', website: 'https://www.burgerandlobster.com/', city: "New York", state: "NY", zip_code: 10018, business_category_id: business_categories[0].id, latitude: 41.915495, longitude: -74.002210, price: 3, noise: "loud", delivery: "false"},
  ...
  phone_number: '(718) 596-6700', website: 'https://julianaspizza.com/', city: "New York", state: "NY", zip_code: 10018, business_category_id: business_categories[0].id, latitude: 41.915495, longitude: -74.502210, price: 2, noise: "average", delivery: "true"},
  ...
  phone_number: '(718) 596-6700', website: 'https://joeshanghairestaurants.com', city: "New York", state: "NY", zip_code: 10018, business_category_id: business_categories[0].id, latitude: 41.115495, longitude: -74.502210, price: 2, noise: "loud", delivery: "false"},
  ...
  phone_number: '(212) 302-0650', website: 'https://www.chipotle.com/', city: "New York", state: "NY", zip_code: 10018, business_category_id: business_categories[0].id, latitude: 40.915495, longitude: -74.002210, price: 1, noise: "average", delivery: "false"},
  ...
  phone_number: '(347) 435-2676', website: 'https://www.shake-shack.com/', city: "Brooklyn", state: "NY", zip_code: 11201, business_category_id: business_categories[0].id, latitude: 41.615488, longitude: -74.002300, price: 2, noise: "very loud", delivery: "false" },
  ...
  phone_number: '(917) 410-1761', website: 'https://www.carpetcleaningnycpro.com', city: "Queens", state: "NY", zip_code: 11374, business_category_id: business_categories[1].id ,latitude: 41.888888, longitude: -73.899999, price: 2, noise: "very loud", delivery: "true" },
  ...
  phone_number: '(201) 855-9052', website: 'https://www.maidstay.com', city: "Queens", state: "NY", zip_code: 11374, business_category_id: business_categories[1].id ,latitude: 41.888888, longitude: -73.777777, price: 3, noise: "quiet" , delivery: "true"},
  ...
  phone_number: '(718) 855-9052', website: 'https://www.orbitsecuritysystems.com', city: "Queens", state: "NY", zip_code: 11374, business_category_id: business_categories[1].id ,latitude: 41.331122, longitude: -73.331122, price: 3, noise: "quiet", delivery: "true" },
  ...
  phone_number: '(718) 122-7323', website: 'https://www.rightlawncare.com', city: "Jamaica", state: "NY", zip_code: 11374, business_category_id: business_categories[1].id ,latitude: 40.631888, longitude: -73.899999, price: 1, noise: "average", delivery: "true" },
  ...
  phone_number: '(718) 672-7323', website: 'https://www.jcdesignscapes.com/', city: "Queens", state: "NY", zip_code: 11374, business_category_id: business_categories[1].id ,latitude: 40.888888, longitude: -73.899999, price: 4, noise: "average", delivery: "true" },
  ...
  phone_number: '(646) 869-2070', website: 'https://beannbean.com/', city: "Manhattan", state: "NY", zip_code: 10001, business_category_id: business_categories[2].id, latitude: 41.339181, longitude: -73.703888, price: 1, noise: "loud" , delivery: "false"},
  ...
  phone_number: '(646) 869-2070', website: 'https://absolutecoffee.nyc', city: "Manhattan", state: "NY", zip_code: 10001, business_category_id: business_categories[2].id, latitude: 41.339181, longitude: -73.703888, price: 1, noise: "quiet" , delivery: "false"},
  ...
  phone_number: '(646) 869-2070', website: 'https://beannbean.com/', city: "Manhattan", state: "NY", zip_code: 10001, business_category_id: business_categories[2].id, latitude: 41.111222, longitude: -73.701888, price: 1, noise: "quiet", delivery: "true" },
  ...
  phone_number: '(646) 869-2070', website: 'https://cafedecupping.com/', city: "Manhattan", state: "NY", zip_code: 10001, business_category_id: business_categories[2].id, latitude: 41.231032, longitude: -73.701888, price: 2, noise: "average" , delivery: "false"},
  ...
  phone_number: '(929) 718-3213', website: 'https://www.appacademy.io/', city: "Manhattan", state: "NY", zip_code: 10001, business_category_id: business_categories[3].id ,latitude: 41.565213, longitude: -73.002218, price: 4, noise: "very loud" , delivery: "false"},
  ...
  phone_number: '(718) 718-3213', website: 'http://www.warriorfitnessbootcamp.com/', city: "Brooklyn", state: "NY", zip_code: 11249, business_category_id: business_categories[3].id ,latitude: 40.565213, longitude: -74.002218, price: 3, noise: "very loud" , delivery: "false"},
  ...
  phone_number: '(347) 718-3213', website: 'https://trooperfitness.com/', city: "New York", state: "NY", zip_code: 11249, business_category_id: business_categories[3].id ,latitude: 40.900000, longitude: -74.002218, price: 3, noise: "loud" , delivery: "false"},
  ...
  phone_number: '(929) 718-3213', website: 'https://flatironschool.com', city: "New York", state: "NY", zip_code: 10004, business_category_id: business_categories[3].id ,latitude: 41.631133, longitude: -72.002218, price: 4, noise: "average" , delivery: "false"},
  ...
  phone_number: '(718) 718-3213', website: 'https://www.fullstackacademy.com/', city: "New York", state: "NY", zip_code: 10004, business_category_id: business_categories[3].id ,latitude: 40.331133, longitude: -72.002218, price: 4, noise: "very loud" , delivery: "false"},
  ...
  phone_number: '(929) 718-3213', website: 'https://coffeeprojectny.com', city: "New York", state: "NY", zip_code: 10004, business_category_id: business_categories[2].id ,latitude: 40.333111, longitude: -71.002218, price: 3 , noise: "loud", delivery: "false"},
  ...
  Review.create!([
    {user_id: users[0].id, business_id: businesses[0].id, rating: 4, body: 'My friend got a vanilla drink from there I cant recall the name of but it was fabulous.' },
    {user_id: users[2].id, business_id: businesses[0].id, rating: 5, body: "They also have WiFi so I always see a lot people working or studying there. But it's a small cafe so it's usually packed." },
    {user_id: users[2].id, business_id: businesses[0].id, rating: 5, body: "My go to coffee shop in Brooklyn! Check it out." },
    {user_id: users[1].id, business_id: businesses[0].id, rating: 4, body: "The service is pretty quick and efficient, and the staff members are so friendly! If I lived in the area, this would be a place I'd frequent." },
    {user_id: users[0].id, business_id: businesses[0].id, rating: 4, body: "Great espresso. Keep in mind that a regular espresso here is a double size!" },
    {user_id: users[2].id, business_id: businesses[0].id, rating: 3, body: "We were here at about 6pm and there weren't many choices for desserts left. We got a latte, a matcha and a toasted coconut donut." },
    {user_id: users[0].id, business_id: businesses[1].id, rating: 5, body: "You certainly are expected to work as much as you everyday. Everyone is incredibly smart and motivated; I went to a top school in the United States, but found my peers here to be heads and tails above my university peers." },
    {user_id: users[2].id, business_id: businesses[1].id, rating: 5, body: "I had absolutely NO computer science background before attending, and ended up getting a job within the first month following the program, so this program DEFINITELY fulfills its promises." },
    {user_id: users[1].id, business_id: businesses[1].id, rating: 5, body: "I was a part of the NYC March cohort (Mar - Jun 2018) and purposely waited to write my review until I accepted a job after completing the program." },
    {user_id: users[1].id, business_id: businesses[1].id, rating: 5, body: "If you are someone who wants to change the direction of your life or want to get into programming for whatever reason, AND above all else is willing to put in the hours to do it, do not hesitate and go for it. You won't regret it" },
    {user_id: users[3].id, business_id: businesses[1].id, rating: 5, body: "Give the program 100% and you will become a great developer. There are developer jobs in every country you would want to live in, it's a great skill to have." },
    {user_id: users[0].id, business_id: businesses[1].id, rating: 5, body: "You will crush interviews - every company I visited was thorougly impressed with my abilities. Many grads go to very recognizable companies!" },
    {user_id: users[0].id, business_id: businesses[1].id, rating: 5, body: "App Academy is life changing. Your time there will be brutal but when you receive your first offer, you'll know immediately that it was all worth it." },
    {user_id: users[1].id, business_id: businesses[2].id, rating: 2, body: "I've gone there off and off over the last few years and while the coffee and food is quite nice, they hire some pretty rude people. The woman that took my order looked at me like our families have been rivals for centuries." },
    {user_id: users[2].id, business_id: businesses[2].id, rating: 4, body: "Cool clean and modern coffee shop featuring a wide selection of coffees, teas and even beers. Service is friendly and quick and the matcha latte was excellent and very potent." },
    {user_id: users[0].id, business_id: businesses[2].id, rating: 3, body: 'My go to spot to study and chat with friends over some coffee. Love the atmopshere and such a clean and tidy place.' },
    {user_id: users[2].id, business_id: businesses[2].id, rating: 4, body: 'Cold brew tasted like a super dark roast without any sweet or fruity subtle notes.  Kinda harsh like starbucks. The coffee only tasted drinkable with some half and half.' },
    {user_id: users[1].id, business_id: businesses[2].id, rating: 1, body: "I was supremely disappointed and will not be visiting again." },
    {user_id: users[1].id, business_id: businesses[2].id, rating: 4, body: "Good place to study paired with good coffee! I love finding ample study space and outlets in New York coffee shops because its not easy to come by! " },
    {user_id: users[1].id, business_id: businesses[3].id, rating: 5, body: "My mouth is watering thinking about the lemon butter sauce... Okay so, it's not the most amazing lobster, but it's still good. The sauce is what always gets me. Get it! And also the fries... I just love fries." },
    {user_id: users[2].id, business_id: businesses[3].id, rating: 4, body: "Their lobster roll actually had more flavor than my whole lobster, which is fine I'll just get it next time. I'd recommend trying this place out if you're hungry!" },
    {user_id: users[2].id, business_id: businesses[3].id, rating: 5, body: "Best lobster roll I've ever had (I'm from Florida, so a decent lobster roll is hard to come by). Love how the bread hold everything in to reduce mess. Would 10/10 recommend." },
    {user_id: users[0].id, business_id: businesses[3].id, rating: 1, body: "I'm not sure I'm understanding where the hype is coming from. The food was decent, but nothing to rave about, and certainly not enough to have me return here." },
    {user_id: users[3].id, business_id: businesses[3].id, rating: 4, body: "Good vibes, good customer service, good food!!! It is a bit pricey, but hey, what can you expect from a good lobster roll place??"},
    {user_id: users[2].id, business_id: businesses[3].id, rating: 4, body: "I got the original lobster roll and the samurai. Both around $20~25, but it comes with a side of fries and salad. Recommend if you're bougie$$" },
    {user_id: users[2].id, business_id: businesses[4].id, rating: 5, body: "By far, my favorite go-to cafe in Flushing to be ultra-productive. It has consistently been the place I've gotten all my work done for my job/school over the past few years and also a great spot to catch up with friends." },
    {user_id: users[1].id, business_id: businesses[4].id, rating: 4, body: "Coffee prices are decent (around $3-5, depending on what you get) and the Americanos and lattes are well-balanced in flavour--no complaints in my book." },
    {user_id: users[0].id, business_id: businesses[4].id, rating: 4, body: "We came here for a quick latte/coffee and it was a great spot to relax, unwind, and even sit and do some work while you enjoyed a drink." },
    {user_id: users[0].id, business_id: businesses[4].id, rating: 3, body: "Wish I had something better to say, but I tried the coffee and tea: both were okay. The tiramisu was not good, I have made better with my amateur baking skills." },
    {user_id: users[3].id, business_id: businesses[4].id, rating: 5, body: "One of the best cafes along the long streets of Northern Boulevard here. We had the honey bread with matcha ice cream on top and it was amazing. The honey bread was nice and crispy on the outside and soft and doughy on the inside. Matcha ice cream looks really dark, but it's not bitter." },
    {user_id: users[0].id, business_id: businesses[4].id, rating: 4, body: "Their coffees here are usually always solid here. My friend ordered the cortada and loved it. It's a nice cafe to chill, unwind and get some work done." },
    {user_id: users[1].id, business_id: businesses[4].id, rating: 4, body: "I always come here occasionally when I'm around the area. When I do come, I always get the Rose temptation iced tea. If you're trying to avoid coffee, this is a wonderful alternative!" },
    {user_id: users[3].id, business_id: businesses[5].id, rating: 4, body: "Later I called them to book appointment and everything went well smoothly. They had done an incredible job, carpet now looks fresh and new." },
    ...
    {user_id: users[2].id, business_id: businesses[5].id, rating: 5, body: " NYC Pros came through for us big time.  Got us a fair price right away and was able to get the work done to meet my schedule.  Thank for all the help!" },
    {user_id: users[0].id, business_id: businesses[5].id, rating: 4, body: "After a week of babysitting my nephews, along with cat sitting my brother two cats. My carpet was in desperate need of cleaning. I scheduled a cleaner and they show up right on time." },
    {user_id: users[2].id, business_id: businesses[5].id, rating: 4, body: "They did a amazing impeccable job on my carpet, it looks brand new again!! Professional and friendly, with affordable prices. It was top notch service all around." },
    {user_id: users[2].id, business_id: businesses[5].id, rating: 4, body: "Thank you so much Carpet Cleaning! I really could not be happier with the result! My living room carpet looks amazing! After years of wearing out outdoor shoes all over it, my carpet went from beige to grey dark spots all over. " },
    {user_id: users[3].id, business_id: businesses[6].id, rating: 1, body: "Don't be fooled by the the average star ratings like me, read reviews before you go! I was shock by how stingy the portion they gave, even the brown rice and beans! Not to mention the chicken! Unbelievable. By far the most stingy location I've ever been." },
    {user_id: users[1].id, business_id: businesses[6].id, rating: 1, body: "They broke the record. I had a chicken bowl, I felt I got a veggie bowl. I can count the pieces of chicken and to make it worse, they didn't even taste good. Dry and chewy. The people behind the bar were not friendly at all. They had no clue what customer service was. This was my first and last time here." },
    {user_id: users[3].id, business_id: businesses[6].id, rating: 3, body: "I have been waiting for years to eat here. Left vastly disappointed. The food was ok at best. The servers service was awful. I make question and they weren't responsive . For me this was subway with a texmex vari" },
    {user_id: users[1].id, business_id: businesses[6].id, rating: 1, body: "This is the worst chipotle I have ever been to and I am a certified chipotle addict! I work near by and have been here several times but I am completely done with this location for good! The portions they give you are disgustingly unacceptable!" },
    {user_id: users[2].id, business_id: businesses[6].id, rating: 4, body: "Ever since working nearby at a salad place, I go to this chipotle store location almost everyday. The environment is pleasant , the food tastes great and the employees are very helpful. In particular, the pretty girl with the curly hair always keeps a smile on my face " },
    {user_id: users[3].id, business_id: businesses[7].id, rating: 4, body: "Good place to work. Limited space (comfortably fits 10 people.) Outside bench available. Classy baristas. Unique decorations (ie. upside down chemistry lab beaker used as coffee drip.)"},
    {user_id: users[2].id, business_id: businesses[7].id, rating: 2, body: " My friend and I were really really disappointed with the coffee. The cold brew was watered down. I told them I love  strong black coffee and they recommended Costa Rica coffee. I was so excited and can't wait to try it." },
    {user_id: users[1].id, business_id: businesses[7].id, rating: 2, body: "The only good was the deconstructed latte, it was unique and cute for Instagram. I don't really like latte but it's pretty good. It comes with a shot of espresso and I enjoyed that. I should have just order the espresso." },
    {user_id: users[0].id, business_id: businesses[7].id, rating: 4, body: "The deconstructed latte was a shot of espresso and some milk followed by the actual latte. The espresso by itself was very strong and a bit sour. The complete latte was smooth and comforting. It was the perfect spot to catch up with a friend!" },
    {user_id: users[0].id, business_id: businesses[7].id, rating: 5, body: "I pass this coffee shop most days on my commute. After my first visit here today, I may just have to start waking up 5 minutes earlier to add it to my weekday routine. (And budgeting an extra $5 a day into my currently modest coffee expenses.)"},
    ...
    {user_id: users[1].id, business_id: businesses[18].id, rating: 4, body: "LOVE this place! I came for the first time about 3 weeks ago and was immediately hooked, now I can't go a few days without signing up for a class. Luckily I live right around the corner so no complaints there!" },
    ])
