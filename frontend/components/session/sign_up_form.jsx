    ...
    return (
      <div>
        ...
        <form className="formtype-form" onSubmit={this.handleSubmit}>
          ...
          <div className='signup-birthday'>Birthday
          ...
          <div className='birthday'>
            <select onChange={this.updateBirthday('month')} className='month' id='monthddl'>
            ...
            <select onChange={this.updateBirthday('day')} className='day' id='dayddl'>
            ...
            <select onChange={this.updateBirthday('year')} className='day' id='blah'>
