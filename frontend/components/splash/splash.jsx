    ...
    if (this.props.currentUser) {
      return (
        <div>
          <div
            className="container"
            style={{ backgroundImage: `url(${window.splashBackground})` }}
          >
            <div className="header">
              <div className="header-nav">
                <ul className="header-review">
                  <Link className="write-review" to="/businesses">
                    Write a Review
                  </Link>
                </ul>
            ...
            <div className="brand-name">
              ...
              <Link to="/">
                <img className="brand" src={window.betterHelpSplash} />
              </Link>
            </div>
          </div>
          <div className="slogan-container">
            <h3 className="slogan">Find the Best Businesses in Town</h3>
          </div>
          <div className="hot-new-sign"> Hot & New Businesses </div>

          <div className="display-bus">{businesses}</div>

          <div className="recent-activity-wrapper">
            <div className="recent-activity">Recent Activities</div>
          </div>

          <div className="review-bus">{reviews}</div>
          <div className="browse-category-container">
            ...
            <div className="category-bus">{businessCategories}</div>
          </div>
        </div>
      );
    } else {
