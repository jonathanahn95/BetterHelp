...
class SplashBusinesses extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Link to={`/businesses/${business.id}`}><img className="splash-pics" src={business.photos[0].photo_image_url}></img></Link>
      <Link to={`/businesses/${business.id}`}><li className='splash-bus-name'>{business.name}</li></Link>
