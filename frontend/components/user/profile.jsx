        ...
        <div className="user-prof-wrapper">
          ...
          <div className="user-prof-wrapper2">
            <div className="user-prof-full-name">
              ...
              <div>{this.props.currentUser.lname}</div>
            </div>
            <div className="user-prof-location">Manhattan, NY</div>
          </div>
        </div>

        {reviewLength}

        <div className="user-reviews-wrapper">{this.userReviews()}</div>
      </div>
    );
  }
}
