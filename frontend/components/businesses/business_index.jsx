      ...
      <div>
        ...
        <div className="first-review-container">
          <div className="awaits-container">
            ...
            <h2 className="need-help-p">
              Review your favorite businesses and share your experiences with
              our community. Need a little help getting started?
            </h2>
            <div>
              <SearchFormContainer
                show={"false"}
                className={"nav-sear-container"}
              />
            </div>
          </div>
          <img
            className="write-pic"
            src="https://s3.amazonaws.com/betterhelp-dev/first_review.png"
          />
        </div>
        ...
        <div className="write-review-main-business-container">
          ...
          <div className="write-review-business-container">{businesses}</div>
        </div>
      </div>
    );
  }
